...
def roll_dice(num_rolls, dice=six_sided):
    ...
    for x in range(num_rolls):
        single_dice = dice()    # call dice() to obtain a single outcome of a dice roll
        if single_dice == 1:
            return 1
        else:
...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    score_0, score_1 = score % 10, score // 10
    return abs(score_1 - score_0) + 2
    # END PROBLEM 2
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        ...
        # Commentary current game at the end of each turn        
        if turn == 1:
            h = say(score0, score1)
        else:
            h = h(score0, score1)
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    # BEGIN PROBLEM 7
    def say(score0, score1):
        if who: #announce Player 1's score change
            score = score1
        else:   #announce Player 0's score change
            score = score0

        # nonlocal previous_score, previous_high
        # change = score - previous_score
        # previous_score = score
        # # previous_score = score  # (without keyword nonlocal, why assigning to previous_score causes error?)
